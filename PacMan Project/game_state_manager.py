...
class GameStateManager:
    ...
    def restart(self):
        ...
        self.level = 1
=======
from constraints import CHASE, CHASE_DURATION, EATEN, GAME_OVER, HOUSE, PAUSED, PLAYING, SCATTER, SCATTER_DURATION, START, WIN
...
class game_state_manager:
    def __init__(self):
        self.state          = START
        self.level          = 1
        self.high_score     = load_high_score_from_file()
